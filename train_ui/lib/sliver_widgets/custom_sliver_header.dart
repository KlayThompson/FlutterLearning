...
class CustomSliverHeaderDemo extends StatelessWidget {
  final String title;
  CustomSliverHeaderDemo({Key key, @required this.title}) : super(key: key);
...
class CustomSliverPersistentHeaderDelegate
  ...
  double get minExtent => this.collapseHeight + this.paddingTop;
  @override
  ...
  Color makeStickyHeaderTextColor(shinkOffset, isIcon) {
    if (shinkOffset <= 50) {
      return isIcon? Colors.white : Colors.transparent;
    } else {
      final int alpha = (shinkOffset / (this.maxExtent - this.minExtent) * 255).clamp(0, 255).toInt();
